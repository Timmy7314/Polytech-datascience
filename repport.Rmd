...
Afin de connaître les liens entre les variables d'entrée, nous allons prendre l'ensemble des 11 variables d'entrée ainsi que les 50 premiers vins. Nous avons fait le choix de cet échantillon, car si nous faisons le plot de chaque jeu de données complet, le résultat sera illisible.

```{r}
# 50 rows and 11 columns
RWineR50C11 <- RWine[1:50, 1:11]
plot(RWineR50C11, main = "Plot of 50st Red Wines")
```

```{r}
WWineR50C11 <- WWine[1:50, 1:11]
plot(WWineR50C11, main = "Plot of 50st White Wines")
```